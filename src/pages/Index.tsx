                        ...
                        <TooltipTrigger asChild>
                          {f.logo_url ? (
                            <a href={f.url ?? "#"} target="_blank" rel="noopener noreferrer" className="shrink-0">
                              <img src={f.logo_url} alt="" className="w-8 h-8 rounded-lg object-cover hover:opacity-75 transition-opacity outline outline-1 outline-foreground/50" />
                            </a>
                          ) : (
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <a
                            ...
                            className="text-2xl font-medium text-foreground w-56 min-w-56 shrink-0 whitespace-nowrap overflow-hidden text-ellipsis hover:text-foreground/70 transition-colors"
                          >
