                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <a
                            ...
                            className="text-2xl font-medium text-foreground w-72 min-w-72 shrink-0 whitespace-nowrap overflow-hidden text-ellipsis hover:text-foreground/70 transition-colors"
                          >
